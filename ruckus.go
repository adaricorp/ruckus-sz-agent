...
func handleApStatus(systemID string, message *pb.APStatus) error {
	...
	apMetrics := map[string]interface{}{
		...
		"ruckus_ap_rx_error_packets_total":          apSystem.GetRxErrorPkts(),
		"ruckus_ap_tx_error_packets_total":          apSystem.GetTxErrorPkts(),
		"ruckus_ap_rx_drop_packets_total":           apSystem.GetRxDropPkts(),
		"ruckus_ap_tx_drop_packets_total":           apSystem.GetTxDropPkts(),
